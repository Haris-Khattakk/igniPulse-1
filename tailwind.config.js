  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-text-mix-1":
          "linear-gradient(to right, #FF0000, #FFD700, #00FF00)",
        "gradient-text-mix-2":
          "linear-gradient(to right, #00BFFF, #8A2BE2, #FF1493)",
        "gradient-text-mix-3":
          "linear-gradient(to right, #1E90FF, #FF6347, #FFFF00)",
        "gradient-text-mix-4":
          "linear-gradient(to right, #FFA500, #8A2BE2, #FF69B4)",
        "gradient-text-mix-5":
          "linear-gradient(to right, #DDA0DD, #FF6347, #00FF00)",
        "gradient-text-mix-6":
          "linear-gradient(to right, #FF0000, #00CED1, #FFD700)",
        "gradient-text-mix-7":
          "linear-gradient(to right, #FF1493, #00BFFF, #008080)",
        "gradient-text-mix-8":
          "linear-gradient(to right, #1E90FF, #FF8C00, #7CFC00)",
        "gradient-text-mix-9":
          "linear-gradient(to right, #FF6347, #00FF00, #FF1493)",
        "gradient-text-mix-10":
          "linear-gradient(to right, #8A2BE2, #FFFF00, #FFD700)",
        "gradient-text-mix-11":
          "linear-gradient(to right, #00BFFF, #FF6347, #FFA500)",
        "gradient-text-mix-12":
          "linear-gradient(to right, #FF8C00, #DDA0DD, #00FF00)",
        "gradient-text-mix-13":
          "linear-gradient(to right, #FF1493, #FFD700, #1E90FF)",
        "gradient-text-mix-14":
          "linear-gradient(to right, #FF6347, #8A2BE2, #7CFC00)",
        "gradient-text-mix-15":
          "linear-gradient(to right, #008080, #00CED1, #FF0000)",
        "gradient-text-mix-16":
          "linear-gradient(to right, #FF69B4, #FFD700, #FF1493)",
        "gradient-text-mix-17":
          "linear-gradient(to right, #FF8C00, #00BFFF, #1E90FF)",
        "gradient-text-mix-18":
          "linear-gradient(to right, #FFFF00, #8A2BE2, #00FF00)",
        "gradient-text-mix-19":
          "linear-gradient(to right, #7CFC00, #008080, #00CED1)",
        "gradient-text-mix-20":
          "linear-gradient(to right, #FF1493, #FF0000, #00FF00)",
